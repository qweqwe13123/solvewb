...
export const Route = createFileRoute("/c/members")({
  component: MembersComingSoon,
});

function MembersComingSoon() {
  return (
    <section className="grid min-h-[420px] place-items-center rounded-xl border border-border bg-card p-8 text-center">
      <div>
        ...
        <h1 className="mt-3 text-3xl font-bold">Members</h1>
        <p className="mt-3 text-muted-foreground">Member profiles and discovery are coming soon.</p>
